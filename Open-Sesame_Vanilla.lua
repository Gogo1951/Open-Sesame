...
local function DeleteLowValue()
        ...
        for slot = 1, numSlots do
            ...
            if itemInfo and itemInfo.hyperlink then
                ...
                if AllowedDeleteQuestItems[itemID] and IsAnyQuestCompleted(AllowedDeleteQuestItems[itemID]) then
                    ...
                    print(
                        string.format(
                            "|cff4FC3F7Open Sesame|r : Erasing %s! This item was associated with a quest you have already completed.",
                            itemInfo.hyperlink
                        )
                    )
    ...
    if lowestBag and lowestSlot then
        ...
        print(
            "|cff4FC3F7Open Sesame|r : Congratulations, your bags are full of good stuff! You'll have to manually delete something if you need to free up more space."
        )
    end
end
